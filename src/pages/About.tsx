          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-8 text-center space-y-4">
                ...
                <p className="text-muted-foreground">{t("about.values.accessibilityDesc")}</p>
              </Card>
              ...
              <Card className="p-8 text-center space-y-4">
                ...
                <p className="text-muted-foreground">{t("about.values.transparencyDesc")}</p>
              </Card>
              ...
              <Card className="p-8 text-center space-y-4">
                ...
                <p className="text-muted-foreground">{t("about.values.innovationDesc")}</p>
              </Card>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-6xl mx-auto space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4 text-center md:text-left">
                  ...
                  <p className="text-muted-foreground">{t("about.team.vasliddinDesc")}</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4 text-center md:text-right order-2 md:order-1">
                  ...
                  <p className="text-muted-foreground">{t("about.team.asadbekDesc")}</p>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4 text-center md:text-left">
                  ...
                  <p className="text-muted-foreground">{t("about.team.adibaDesc")}</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4 text-center md:text-right order-2 md:order-1">
                  ...
                  <p className="text-muted-foreground">{t("about.team.daurenDesc")}</p>
                </div>
                <div className="flex justify-center md:justify-start order-1 md:order-2">
                  <img
                    src={daurenImage}
